 ...
 * John: Modified to suit personal needs, need to modify the interfaces before real personalization to PiDome can be made.
 */
public class HawtDBPersistentStore implements IMessagesStore, ISessionsStore {
    ...
    private HashMap<String, List<StoredPublishEvent>> m_persistentMessageStore = new HashMap<>();
    private HashMap<String, StoredMessage> m_retainedStore = new HashMap<>();
    //bind clientID+MsgID -> evt message published
    private HashMap<String, StoredPublishEvent> m_inflightStore = new HashMap<>();
    //bind clientID+MsgID -> evt message published
    private HashMap<String, StoredPublishEvent> m_qos2Store = new HashMap<>();

    //persistent Map of clientID, set of Subscriptions
    private HashMap<String, Set<Subscription>> m_persistentSubscriptions = new HashMap<>();
