UPDATE installed_devices SET `xml`='<device>
    ...
    <commandset>        
        ...
        <group id="data" label="Keypad data">
            ...
            <data description="Master code" datatype="string" hidden="false" id="mastercode" retention="false" extra="" visual="none" prefix="" suffix="" graph="none"/>
            <data description="Master card" datatype="string" hidden="false" id="mastercard" retention="false" extra="" visual="none" prefix="" suffix="" graph="none"/>
        </group>
    </commandset>
</device>' WHERE `name`='pidomekeypadpresencedevice';
ALTER TABLE installed_packages ADD COLUMN 'permissions' TEXT NOT NULL DEFAULT "{}";
