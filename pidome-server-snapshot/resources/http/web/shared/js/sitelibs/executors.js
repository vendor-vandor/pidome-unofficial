...
/**
 * All ajax calls should not be cached.
 * @param {type} param
 */
$.ajaxSetup({
    cache: true, //// All the ajax calls we make sould REALLY not be cached. If otherwise use $.ajax with cache true to turn on caching
...
function setPageBreadcrumbs(menuIndex, selectedId, menuItem, href, subItem) {
    ...
    path[1] = menuItem;
    var fullstring = "<li><a href=\"/desktop/index.html\" onclick=\"return loadPageContent(this, 0, 'page_dashboard');\"><img src=\"/shared/images/icons/home.png\" alt=\"Dashboard\" /> Dashboard</a><span class=\"breadcrumbsarrow first\"  style=\"display:none;\">&gt;</span></li>";
    if (path[0]!==""){
