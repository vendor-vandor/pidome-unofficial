...
/**
 * Primitive rule for floats.
 * @author John Sirach
 */
public class RuleIfNumberFloat implements RuleIfPrimitives {
     ...
     * @param subject 
     */
    protected RuleIfNumberFloat(float subject){
    ...
    public boolean greaterThen(Object compareTo) {
        return subject < ((float)compareTo);
    }
