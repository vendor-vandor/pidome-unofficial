 ...
 * @author John
 */
public class Webclient_driversedit extends Webservice_renderer {
    ...
    public void collect() {
        ...
        pageData.put("page_title", "Driver settings");
        
        pageData.put("drivercollection", DeviceService.getRunningDriversCollection());
