 ...
 * @author John
 */
public class AutomationVariable extends AutomationVariableImpl {

    public AutomationVariable(ObjectPropertyBindingBean var, String name) {
        super(var, name);
    }
    
    @Override
    public void destroy() {
        /// Unneded in simple var
    }
