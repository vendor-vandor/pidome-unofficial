...
case $1 in  
    ...
    *)
        ...
        sudo nohup $JAVA_LOC -Xbootclasspath/p:libs/alpn-boot-8.1.6.v20151105.jar -XshowSettings:properties -Djava.security.debug=access,failure -Dlog4j.configurationFile=config/log4j2.xml -Djava.awt.headless=true -Dfile.encoding="UTF-8" -jar pidome-server.jar $1 $2 $3 >initial.log 2>&1 &
        while [ ! -f $PIDFILE ]
        do
              sleep 1
              echo -n "."
