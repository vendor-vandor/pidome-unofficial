...
function RPCSocket(wsSocketEndpoint){
    ...
    this.falseReason = "Real time updates unavailable: No browser request made";
...
RPCSocket.prototype.onOpen = function(evt){
    ...
    this.statusReason = "Real time updates active";
...
RPCSocket.prototype.onClose = function(evt){
    ...
    this.statusReason = "Real time updates unavailable: Connection closed";
};
...
RPCSocket.prototype.Init = function(){
    ...
    try {
        ...
        this.statusReason = "Real time updates unavailable: " + err;
        this.setIsAvailable(false);
    }
};
 ...
 * @returns {undefined}
 */
RPCSocket.prototype.getStatusReason = function(){
 ...
 * @returns {undefined}
 */
RPCSocket.prototype.getIsAvailable = function(){
 ...
 * @returns {undefined}
 */
RPCSocket.prototype.setIsAvailable = function(status){
    try {
        this.openStatus = status;
        if(this.openStatus){
            $(document).ready(function() {
                $('#ws_enabled').addClass("available");
            });
        }
    } catch (err){
        console.log(err);
