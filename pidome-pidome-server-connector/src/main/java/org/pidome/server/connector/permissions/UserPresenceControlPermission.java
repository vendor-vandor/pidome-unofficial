...
/**
 * Permission used for devices that want to control user presence.
 * @author John
 */
public final class UserPresenceControlPermission  extends Permission {

    private final String action;
    
    public UserPresenceControlPermission(String target, String action){
        super(target);
        this.action = action;
    }
