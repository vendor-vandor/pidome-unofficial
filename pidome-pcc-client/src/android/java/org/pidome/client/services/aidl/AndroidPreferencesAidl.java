 ...
 */
package org.pidome.client.services.aidl;
 ...
 * @author John
 */
public class AndroidPreferencesAidl implements LocalPreferenceStorageInterface {
    
    private final SharedPreferences preferences;
    private final SharedPreferences.Editor preferencesEditor;
    
    public AndroidPreferencesAidl(Context context){
