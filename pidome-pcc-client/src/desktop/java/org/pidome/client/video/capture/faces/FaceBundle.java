...
public class FaceBundle implements Serializable {
    ...
    private final double[][] imageRows;  // each row contains a training image 
    private final ArrayList<String> imageFnms;
    private final double[] avgImage;   // average training image
    private final double[][] eigenFaces;     // the eigenvectors for the face images
    ...
    public double[][] calcWeights(int numEFs) /* Calculate the weights for the chosen subset of eigenfaces.
