...
public class VisualFloorUtils {
    ...
    protected static InputStream loadSmallDeviceImage(Device device) throws IOException {
        return VisualFloorUtils.class.getResource("/org/pidome/client/appimages/floormap/assets/" +device.getDeviceSubcategoryId()+ ".png").openStream();
    }
    
    protected static InputStream loadMovementImage() throws IOException{
        return VisualFloorUtils.class.getResource("/org/pidome/client/appimages/floormap/assets/10.png").openStream();
    }    
    
    protected static ByteArrayInputStream loadDeviceIageResized(Device device, int width, int height) throws IOException {
        BufferedImage img = ImageIO.read(VisualFloorUtils.class.getResource("/org/pidome/client/appimages/floormap/assets/" +device.getDeviceSubcategoryId()+ ".png").openStream());
