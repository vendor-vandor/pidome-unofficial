...
package org.pidome.plugins.media.kodi14;
 ...
 * @author John
 */
public class Kodi14 extends Xbmc12 {
    
    static Logger LOG = LogManager.getLogger(Kodi14.class);
    ...
    public void handleConnectionEvent(String event) {
        switch(event){
            case "CONNECTED":
                ...
                supplement[0] = "PiDome";
                supplement[1] = "Connected with plugin Kodi 14";
                try {
