 ...
 * @author John
 */
public class KeypadTokenAuthenticationControl extends DeviceControl {

    public KeypadTokenAuthenticationControl() throws DeviceControlException, DeviceControlsGroupException {
        super(new DeviceControlsGroup("custom", "Custom"), DeviceControlType.CUSTOM, "customtokenauthcontrol");
    }
