 ...
 * @author John
 */
public class KeypadTokenEditSuccessControl extends DeviceControl {

    public KeypadTokenEditSuccessControl() throws DeviceControlException, DeviceControlsGroupException {
        super(new DeviceControlsGroup("custom", "Custom"), DeviceControlType.CUSTOM, "customtokeneditsuccesscontrol");
    }
