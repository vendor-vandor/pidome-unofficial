 ...
 * @author John
 */
public class KeypadTimeUpdateControl extends DeviceControl {

    public KeypadTimeUpdateControl() throws DeviceControlException, DeviceControlsGroupException {
        super(new DeviceControlsGroup("custom", "Custom"), DeviceControlType.CUSTOM, "customcontroltimeupdater");
    }
